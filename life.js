...
function setupGallery(contentId, containerId) {
    const container = document.getElementById(containerId);
    const title = document.querySelector(`#${contentId} #title`);
    const date = document.querySelector(`#${contentId} #date`);
    const about = document.querySelector(`#${contentId} #about`);
  ...
  // Call this for each gallery
  setupGallery("content-dyed", "imageContainer-dyed");
  setupGallery("content-quilts", "imageContainer-quilts");
  setupGallery("content-paintings", "imageContainer-paintings");
